...
git archive --format=tar HEAD | gzip -9 > rpmbuild/SOURCES/ovirt-engine-extension-logger-log4j-$VERSION.tar.gz
...
rpmbuild \
    ...
    -bs --nodeps ovirt-engine-extension-logger-log4j.spec
